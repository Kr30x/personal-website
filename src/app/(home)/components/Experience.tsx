  ...
  const experiences = [
    {
      ...
      description:
        "Разрабатываю парсеры и генерацию датасетов для веб-поиска Яндекса. Управляю хранилищами оценок поисковых разметок и аналитикой по ним. Строю инфраструктуру рейтинга разметчиков данных.",
      current: true,
    },
    {
